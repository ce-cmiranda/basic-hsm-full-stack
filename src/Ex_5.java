...
public class Ex_5 {
	...
	public static void main(String[] args) {
		...
		//Para resolver este exercício, seguindo o padrão de análise por grupo, teria que
		//criar um novo grupo empresarial, criar uma lista desses grupos empresariais, e iterar
		//esta lista calculando o balanço de cada uma, colocando um condicional para trazer os dados
		//dos sócios. Farei posteriormente
